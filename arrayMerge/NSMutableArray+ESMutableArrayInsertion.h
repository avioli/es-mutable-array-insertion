...
extern NSString *const ESMutableArrayOptionExcludeIntersectionsKey;
extern NSString *const ESMutableArrayOptionDebugLoggingKey;

@interface NSMutableArray (ESMutableArrayInsertion)

/** Adds the objects contained in another given array to the array's contents at a given index.
 *
